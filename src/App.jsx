...
function getCountry(p,ph,l){if(p){if(JP_PREFS.includes(p))return"Japan";if(COUNTRY_MAP[p])return COUNTRY_MAP[p]}if(ph&&PHONE_MAP[ph])return PHONE_MAP[ph];if(l){if(l==="日本語")return"Japan";if(l==="英語")return"International (EN)";if(l.includes("中国語"))return"Taiwan";if(l==="韓国語")return"South Korea"}return"Unknown"}
